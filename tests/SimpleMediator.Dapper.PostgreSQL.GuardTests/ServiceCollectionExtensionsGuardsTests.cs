...
public class ServiceCollectionExtensionsGuardsTests
{
    ...
    /// <summary>
    /// Verifies that AddSimpleMediatorDapper with connection string throws ArgumentException when connectionString is empty.
    /// </summary>
    [Fact]
    public void AddSimpleMediatorDapperWithConnectionString_EmptyConnectionString_ThrowsArgumentException()
    {
        // Arrange
        var services = new ServiceCollection();
    ...
    /// <summary>
    /// Verifies that AddSimpleMediatorDapper with connection string throws ArgumentException when connectionString is whitespace.
    /// </summary>
    [Fact]
    public void AddSimpleMediatorDapperWithConnectionString_WhitespaceConnectionString_ThrowsArgumentException()
    {
        // Arrange
        var services = new ServiceCollection();
