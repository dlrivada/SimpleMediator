...
using SimpleMediator.Dapper.Inbox;
using SimpleMediator.Dapper.Outbox;
using SimpleMediator.Dapper.Sagas;
using SimpleMediator.Dapper.Scheduling;
...
namespace SimpleMediator.Dapper;

/// <summary>
/// Extension methods for configuring SimpleMediator with Dapper.
/// </summary>
