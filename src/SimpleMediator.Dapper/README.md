# SimpleMediator.Dapper

Dapper implementation for SimpleMediator messaging patterns including Outbox, Inbox, Saga orchestration, and Scheduled messages.
